        ...
        <>
            <div className="xwrap" style={{ paddingBottom: 45 }}>
                ...
                <div className="boxes_wraper">
                    <SubPart5X level={1} ammount={"100"} lang={props.lang && props.lang} />
                    <SubPart5X level={2} ammount={"200"} lang={props.lang && props.lang} />
                    <SubPart5X level={3} ammount={"400"} lang={props.lang && props.lang} />
                    <SubPart5X level={4} ammount={"800"} lang={props.lang && props.lang} />
                    <SubPart5X level={5} ammount={"1600"} lang={props.lang && props.lang} />
                    <SubPart5X level={6} ammount={"3200"} lang={props.lang && props.lang} />
                    <SubPart5X level={7} ammount={"6400"} lang={props.lang && props.lang} />
                    <SubPart5X level={8} ammount={"12800"} lang={props.lang && props.lang} />
                    <SubPart5X level={9} ammount={"25600"} lang={props.lang && props.lang} />
                    <SubPart5X level={10} ammount={"51200"} lang={props.lang && props.lang} />
                    <SubPart5X level={11} ammount={"102400"} lang={props.lang && props.lang} />
                    <SubPart5X level={12} ammount={"204800"} lang={props.lang && props.lang} />
                </div>
                <div className="Tips">
